...
import { Col, Row, Button, Avatar, Form, Input, Spin, InputNumber } from "antd";
...
const UserProfile = () => {
  ...
  const [phoneNovalErr, setPhoneValErr] = useState(false);
                    ...
                    <Col span={8}>
                      ...
                      >
                        ...
                        <Form.Item label="Mobile" className="userFormLableCls">
                          ...
                          onChange={(e) => {
                            setPhone(e.target.value); if (e.target.value.length > 10) { setPhoneValErr(true); } }
                          }
                        ...
                        /> */}
                          ...
                          {phoneNovalErr ? (
                            <span style={{ color: "red" }}>
                              Please valid fill Phone number
                            </span>
                          ) : (
                            ""
                          )}
